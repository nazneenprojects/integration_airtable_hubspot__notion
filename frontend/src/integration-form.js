  ...
  return (
    <Box display='flex' justifyContent='center' alignItems='center' flexDirection='column' sx={{ width: '100%' }}>
        ...
        <Box display="flex" justifyContent="center" alignItems="center" mt={4}>
            <Typography variant="h1" color="#333" sx={{ fontSize: "2.5rem", fontWeight: "bold" }}>
                Hubspot Airtable Notion Integration
            </Typography>
        </Box>

        <Box display='flex' flexDirection='column' border={'AppWorkspace'}>
        <TextField
            label="User"
            value={user}
